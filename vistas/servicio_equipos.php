                        ...
                        <div class="col-lg-3" id="cantidad_ii">
                          <div class="form-group">
                            ...
                            <input
                              ...
                              onclick="costo_partcial();"
                              onkeyup="costo_partcial(); calculardia();"
                              onchange="calculardia();"
                            />
                          </div>
                        </div>
                      ...
                      <div class="row" id="cargando-1-fomulario">
                        ...
                        <div class="col-md-6">
                          <div class="row text-center">
                            ...
                            <div class="col-md-6 text-center">
                              <button type="button" class="btn btn-info btn-block btn-xs" onclick="re_visualizacion(1, 'comprobante_pago');"><i class="fas fa-redo"></i> Recargar.</button>
                            </div>
                          </div>
                      ...
                      <div class="row" id="cargando-1-fomulario">
                        ...
                        <div class="col-md-6">
                          <div class="row text-center">
                            ...
                            <div class="col-md-6 text-center">
                              <button type="button" class="btn btn-info btn-block btn-xs" onclick="re_visualizacion(2, 'comprobante_servicio');"><i class="fas fa-redo"></i> Recargar.</button>
                            </div>
                          </div>
