          ...
          if ($_SESSION['recurso']==1){
            ...
            <div class="content-wrapper">
              ...
              <section class="content">
                ...
                <!--Modal ver datos-->
                <div class="modal fade" id="modal-ver-datos">
                        ...
                        <form id="form-imagen" name="form-imagen" method="POST">
                          <div class="card-body">
                            <div class="row" id="cargando-1-fomulario">
                              ...
                              <input type="hidden" name="idservicio_img" id="idservicio_img" />
                              ...
                              <div class="col-md-12 col-lg-12">
                                <label for="doc2_i">Imagen<b class="text-danger">(Imagen)</b> </label>
                                <div class="row text-center">
                                  ...
                                  <div class="col-md-6 text-center comprobante">
                                    <button type="button" class="btn btn-info btn-block btn-xs" onclick="re_visualizacion(2, 'img_perfil');"><i class="fas fa-redo"></i> Recargar.</button>
                                  </div>
                                </div>
                ...
                <div class="modal fade" id="modal-ver-imagen">
                  <div class="modal-dialog modal-dialog-scrollable modal-lg">
                    <div class="modal-content">
                      <div class="modal-header">
                          <h4 class="modal-title"><b>Imagen Para: <span class="text-warning" id="nombre_tipo_imagen"> <i class="fas fa-spinner fa-pulse fa-1x"></i> Cargando... </span>  
                          </h4>
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                          <span class="text-danger" aria-hidden="true">&times;</span>
                        </button>
                      ...
                      <div class="modal-body">
                          <div class="row">
                            <div class="col-lg-12 text-center" id="ver_imagen">
                               <span class="text-warning" id="nombre_tipo_imagen"> <i class="fas fa-spinner fa-pulse fa-1x"></i> Cargando... </span> 
                            </div>
                          </div>
                      </div>
                      <div class="modal-footer justify-content-between">
